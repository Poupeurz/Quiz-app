...
public class QuizNormal extends AppCompatActivity {
    ...
    private void loadAllQuestions() {
        ...
        String jsonquiz=loadJsonFromAsset("questionnormal.json");
        try {
            JSONObject jsonObject = new JSONObject(jsonquiz);
            JSONArray questions=jsonObject.getJSONArray("questionNormal");
    ...
    public void onBackPressed(){
        MaterialAlertDialogBuilder materialAlertDialogBuilder = new MaterialAlertDialogBuilder(QuizNormal.this);
        ...
        materialAlertDialogBuilder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(QuizNormal.this,MainActivity.class));
                finish();
            }
        });
